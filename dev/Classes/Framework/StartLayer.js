var StartLayer = cc.Layer.extend({
    ...
    initMenu: function () {
        ...
        var jump = cc.JumpBy.create(1,cc.PointMake(0,0),7,1);
        menu.runAction(cc.RepeatForever.create(jump));
    ...
    initSprites:function() {	
		...
		var jump = cc.JumpBy.create(2,cc.PointMake(0,0),14,1);
		var eggSprite = cc.Sprite.create(s_small_diamond);
		eggSprite.setPosition(cc.ccp(60,310));
		eggSprite.runAction(cc.RepeatForever.create(jump));
		this.addChild(eggSprite,40);
		...
		var sheepSprite = cc.Sprite.createWithSpriteFrame(sheepFrame1);
		...
		var jump2 = cc.JumpBy.create(2,cc.PointMake(0,0),14,1);
		var rabbit = cc.Sprite.create(s_small_gold);
		rabbit.setPosition(cc.ccp(580,110));
		this.addChild(rabbit,40);
		rabbit.runAction(cc.RepeatForever.create(jump2));
	},
    ...
    onNewGame: function (pSender) {
        ...
        cc.Director.sharedDirector().replaceScene(cc.TransitionSlideInL.create(1.2, scene));
    },
